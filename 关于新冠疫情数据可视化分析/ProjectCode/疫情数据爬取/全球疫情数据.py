...
# f = open(f'./疫情数据/国内疫情数据.csv', 'w', encoding='UTF-8', newline='')
# # 创建写操作
...
for i in tqdm(tbody_list,desc='国内数据写入中'):
    ...
    if i.find_element(By.CSS_SELECTOR, 'tr > td.VirusTable_1-1-317_3x1sDV.VirusTable_1-1-317_2bK5NN').text == '待公布':
        ...
        newly_added = i.find_element(By.CSS_SELECTOR,
                                     'tr > td.VirusTable_1-1-317_3x1sDV.VirusTable_1-1-317_2bK5NN').text
