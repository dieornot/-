...
# data_1_list = [i for i in zip(country_list,cumulative_list)]
# print(data_list)
nameMap = {
    'Singapore Rep.': '新加坡',
    'Dominican Rep.': '多米尼加',
...
A = (
    ...
    Map()
        .add(series_name="海外累计确诊地图", data_pair=[i for i in zip(country_list, cumulative_list)], maptype="world",
             is_map_symbol_show=False, name_map=nameMap)
        .set_series_opts(label_opts=opts.LabelOpts(is_show=False))
        .set_global_opts(visualmap_opts=opts.VisualMapOpts(min_=0, max_=46320000)
                         )
        .render("../可视化/世界疫情分布.html")
)